  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={<MainLayout />}>
        <Route index element={<Navigate to={'/dashboard/purchased-goods-service'} replace />} />
        <Route path="/dashboard/purchased-goods-service" element={<PurchasedGoodsService />} />
        <Route path="/dashboard/upstream-transportation-and-distribution" element={<UpstreamTransportationAndDistribution />} />
        <Route path="/dashboard/waste-generated-in-operations" element={<WasteGeneratedInOperations />} />
        <Route path="/dashboard/business-travel" element={<BusinessTravel />} />
        <Route path="/dashboard/employee-commuting" element={<EmployeeCommuting />} />
        <Route path="/dashboard/downstream-transportation-and-distribution" element={<DownstreamTransportationAndDistribution />} />
        <Route path="/dashboard/end‑of‑life-treatment-of-sold-products" element={<EndOfLifeTreatmentOfSoldProducts />} />
      </Route>
