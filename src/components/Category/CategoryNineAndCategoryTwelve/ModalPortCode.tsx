...
const ModalPortCode = ({ setIsOpen }: Props) => {
  ...
  const handleImport = async () => {
    ...
    Toast.close();
    Toast.fire({
      icon: importExcelPortCode.fulfilled.match(res) ? 'success' : 'error',
      title: importExcelPortCode.fulfilled.match(res)
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4 px-5 py-5">
          {/* Example file link */}
          <a
            href="/excel/Example_Port_Code.xlsx"
            download
