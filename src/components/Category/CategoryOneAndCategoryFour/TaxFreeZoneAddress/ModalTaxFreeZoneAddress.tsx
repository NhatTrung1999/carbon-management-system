...
const ModalTaxFreeZoneAddress = ({ setIsOpen }: Props) => {
  ...
  const handleImport = async () => {
    ...
    Toast.close();
    Toast.fire({
      icon: importExcelTaxFreeZoneAddress.fulfilled.match(res)
        ? 'success'
        : 'error',
      title: importExcelTaxFreeZoneAddress.fulfilled.match(res)
  ...
  return (
    ...
    //       <h1 className="font-semibold text-xl">Tax Free Zone Address</h1>
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4 px-5 py-5">
          {/* Example file link */}
          <a
            href="/excel/Example_Tax_Free_Zone_Address.xlsx"
            download
