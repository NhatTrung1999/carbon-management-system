...
const ModalStyleAutoFill = ({ setIsOpen }: Props) => {
  ...
  const handleImport = async () => {
    ...
    Toast.close();
    Toast.fire({
      icon: importExcelStyleAutoFill.fulfilled.match(res) ? 'success' : 'error',
      title: importExcelStyleAutoFill.fulfilled.match(res)
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4 px-5 py-5">
          {/* Example file link */}
          <a
            href="/excel/Example_Style_Auto_Fill.xlsx"
            download
