          ...
          {data.length > 0 &&
            data.map((item, index) => (
              <tr key={index}>
                ...
                <td className="box-border px-3 py-3">{item.UndDoc}</td>
                <td className="box-border px-3 py-3">{item.DocFlow}</td>
                <td className="box-border px-3 py-3">{item.DocDate}</td>
                <td className="box-border px-3 py-3">{item.DocDate2}</td>
                <td className="box-border px-3 py-3">{item.DocNo}</td>
                <td className="box-border px-3 py-3">{item.UndDocNo}</td>
                <td className="box-border px-3 py-3">{item.CustVenName}</td>
                <td className="box-border px-3 py-3">{item.InvoiceNo}</td>
                ...
                <td className="box-border px-3 py-3">{item.PortType}</td>
                <td className="box-border px-3 py-3">{item.StPort}</td>
                <td className="box-border px-3 py-3">{item.ThPort}</td>
                <td className="box-border px-3 py-3">{item.EndPort}</td>
                <td className="box-border px-3 py-3">{item.Product}</td>
                <td className="box-border px-3 py-3">{item.Quity}</td>
                <td className="box-border px-3 py-3">{item.Amount}</td>
                <td className="box-border px-3 py-3">{item.ActivityData}</td>
                <td className="box-border px-3 py-3">{item.ActivityUnit}</td>
                <td className="box-border px-3 py-3">{item.Unit}</td>
